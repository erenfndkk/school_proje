...
namespace E_Okul_Proje.DataSet1TableAdapters {
    ...
    public partial class TBLDERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::E_Okul_Proje.Properties.Settings.Default.BonusOkulConnectionString;
        }
...
WHERE  (TBLOGRENCILER.OGRAD = @OGRAD)";
        ...
        public virtual DataSet1.DataTable1DataTable OgrenciArama(string OGRAD) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((OGRAD == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
